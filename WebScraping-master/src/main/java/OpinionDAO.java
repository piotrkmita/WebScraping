...
public class OpinionDAO {
    ...
    public boolean createTables() {
        String createOpinions = "CREATE TABLE IF NOT EXISTS opinions (id_opinion INTEGER PRIMARY KEY AUTOINCREMENT, header varchar(255) , opinionContent varchar(255), nick varchar(255), stars varchar(255), opinionDate date, votesFor int, votesAgainst int)";
